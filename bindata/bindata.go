...
func theHookDockerfile() (*asset, error) {
	...
	info := bindataFileInfo{name: "the-hook/Dockerfile", size: 167, mode: os.FileMode(0644), modTime: time.Unix(1613465584, 0)}
...
func theHookDeploymentPatchYaml() (*asset, error) {
	...
	info := bindataFileInfo{name: "the-hook/deployment-patch.yaml", size: 755, mode: os.FileMode(0644), modTime: time.Unix(1613465584, 0)}
